...
public class CustomCylindricalImageKey implements StorableAsMetadata<CustomCylindricalImageKey>, CustomImageKeyInterface
{
    ...
    private final PointingSource source;
	...
	public CustomCylindricalImageKey(String name, String imagefilename, ImageType imageType, PointingSource source, Date date, String originalName)
	{
		this.name = name;
	...
	public static void initializeSerializationProxy()
	{
		InstanceGetter.defaultInstanceGetter().register(CUSTOM_CYLINDRICAL_IMAGE_KEY, (metadata) -> {
	        ...
	        PointingSource source = PointingSource.valueFor(metadata.get(sourceKey));
