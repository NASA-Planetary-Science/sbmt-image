...
import edu.jhuapl.sbmt.image.gui.images.ImageResultsTableView;
    ...
    protected void setupTable()
    {
        ...
        imageResultsTableView.getResultList().getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e)
            {
                ...
                {
                	System.out.println(
							"ImageResultsTableController.setupTable().new ListSelectionListener() {...}: valueChanged: selection listener");
