...
public class ImageKey implements ImageKeyInterface, StorableAsMetadata<ImageKey>
{
    ...
    public final PointingSource source;
    ...
    public ImageKey(String name, PointingSource source)
    {
        this(name, source, null, null, null, null, 0, null);
    }

    public ImageKey(String name, PointingSource source, IImagingInstrument instrument)
    {
...
//                ;
	...
	public static void initializeSerializationProxy()
	{
		InstanceGetter.defaultInstanceGetter().register(IMAGE_KEY, (metadata) -> {
	        ...
	        PointingSource source = PointingSource.valueOf(metadata.get(sourceKey));
