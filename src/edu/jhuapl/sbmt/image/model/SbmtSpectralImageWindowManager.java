...
public class SbmtSpectralImageWindowManager implements WindowManager, PropertyChangeListener
{
    ...
    public SbmtSpectralImageWindowManager(ModelManager modelManager, PopupMenu spectralImagePopupMenu)
    {
        ...
        else
        {
            ...
            spectrumPanel.addWindowListener(new WindowAdapter()
            {
                public void windowClosed(WindowEvent e)
                {
                    ...
                    collectionModel.removePropertyChangeListener(SbmtSpectralImageWindowManager.this);
                }
            });
    ...
    {
        if (model instanceof PerspectiveImageMetadata && ((PerspectiveImage)model).getImageDepth() > 1)
        {
